...
def save_basinvolumes():
    ...
    thetao = ds['thetao'].isel(time_counter=0).values
    ds.close()
    ...
    # Get index of shelfdepth limit
    ibed = np.argmin((lev[:,0]-1000.)**2)
    ...
    ds.to_netcdf('../data/basinvolumes_shelfdepth1000.nc',mode='w')
    ds.close()
